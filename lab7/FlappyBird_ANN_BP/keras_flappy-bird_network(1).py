...
dataset = pd.read_csv('.\lab7\FlappyBird_ANN_BP/training_data.csv', delimiter=',', names=columns)
...
model.fit(X, y, epochs=200, batch_size=100)	# Try playing with these hyperparameters to see what the effect is.
...
model.save(".\lab7\FlappyBird_ANN_BP/flappy_model.keras")
